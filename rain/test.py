...
parser.add_argument('--test_imgs',type=str,default='C:/Users/OKOKPRO/Downloads/mist_raindrop_removal-main/mist_raindrop_removal-main/test_comparison_for_cvpr/test_in',help='Test imgs folder')
